...
LLDB_DIR=$1   # /data/data/com.lyg.beijiuhu.pleaseletmeloadthisso/lldb
LISTENER_SCHEME=$2 #unix-abstract
DOMAINSOCKET_DIR=$3 #/com.lyg.beijiuhu.pleaseletmeloadthisso-0
PLATFORM_SOCKET=$4 #platform-1528087761584.sock
